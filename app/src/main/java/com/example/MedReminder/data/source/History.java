package com.example.MedReminder.data.source;
...
public class History {
    ...
    public History(int hourTaken, int minuteTaken, String dateString, String pillName, int action, String doseQuantity,
