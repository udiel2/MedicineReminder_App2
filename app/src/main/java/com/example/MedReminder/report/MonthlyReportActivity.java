package com.example.MedReminder.report;
...
public class MonthlyReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create Fragment
        MonthlyReportFragment monthlyReportFragment = (MonthlyReportFragment) getSupportFragmentManager()
        ...
        presenter = new MonthlyReportPresenter(Injection.provideMedicineRepository(MonthlyReportActivity.this),
