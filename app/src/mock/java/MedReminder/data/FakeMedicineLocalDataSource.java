...
import com.example.MedReminder.data.source.MedicineDataSource;
...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    private static void addMedicine(long id, int hour, int minute, String pillName, String doseQuantity,
            String doseUnit, int alarmId) {
    ...
    private static void addHistory(int hourTaken, int minuteTaken, String dateString, String pillName, int action,
            String doseQuantity, String doseUnit, int alarmId) {
